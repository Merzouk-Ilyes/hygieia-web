...
const medecinControler4  = require("../../controllers/medecin4"); 
...
//======================RDV==============================
router.get('/RDV', medecinControler4.getRDV);
router.post('/makeRDV', medecinControler4.postRDV);
router.post('/dataupdaterdv', medecinControler4.postdataupdaterdv);
router.post('/updaterdv', medecinControler4.postupdaterdv);

//promo interface
router.get('/RDVpromo', medecinControler.getRDVpromo);
router.post('/makeRDVpromo', medecinControler.postRDVpromo);
router.post('/editRDVpromo', medecinControler.editRDVpromo);
router.post('/cancelRDVpromo', medecinControler.cancelRDVpromo);
